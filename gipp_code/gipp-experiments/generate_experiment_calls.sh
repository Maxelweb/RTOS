                        ...
                        do
                            ...
                            do
                                ...
                                do
                                    ...
                                    echo "python2 ./run_experiments.py --num_cpus 4 8 --load $l -n $n --n_r --n_ls $n_ls --n_ls_r --num_res_nls $q --num_res_ls $qn --acc_max_nls $acc_nls --acc_max_ls $acc_ls --group_size_nls $gs --group_type_nls $gt --asym $as &" >> ./experiment_calls.sh
